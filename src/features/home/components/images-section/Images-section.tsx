  ...
  return (
    ...
    >
      ...
      <div className="right-section">
        ...
        <p>
          For the price of a textbook or two, Osmosis covers virtually every
          Is Osmosis right for my specialty? topic imaginable, on a single
          platform that you can access on your phone.
        </p>
      </div>
    </div>
  );
